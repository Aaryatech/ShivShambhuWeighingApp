...
public class Weighing {
    ...
    public Weighing(int weighId, int vehId, int poklenId, int contraId, float contRate, float quantity, String photo1, String photo2, String remark, int userId, String date, int SubPlantId, float poklenKm, int delStatus) {
        ...
        this.userId = userId;
        this.date = date;
        this.exInt1 = SubPlantId;
       // this.vehKm = vehKm;
        this.poklenKm = poklenKm;
        this.delStatus = delStatus;
    }

    public Weighing(int weighId, int vehId, int poklenId, int contraId, float contRate, float quantity, String photo1, String photo2, String remark, int userId, String date, float poklenKm, int delStatus, int exInt1, String exVar1) {
        this.weighId = weighId;
        this.vehId = vehId;
        this.poklenId = poklenId;
        this.contraId = contraId;
